...
Cloud Volumes ONTAP High Availability with multiple Persistent Disks using Standalone VPC, Tiering and custom firewall rules

## Diagram

![account-id1](./../pics/14-cvoha-standalonevpc.jpg)
