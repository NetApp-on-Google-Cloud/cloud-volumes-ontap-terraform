...
Cloud Volumes ONTAP High Availability with a single Persistent Disk using Shared VPC, Tiering and custom firewall rules

## Diagram

![account-id1](./../pics/18-cvoha-sharedvpc.jpg)
