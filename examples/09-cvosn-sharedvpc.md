...
Cloud Volumes ONTAP Single Node with multiple Persistent Disks using Shared VPC, Tiering and custom firewall rules

## Diagram

![account-id1](./../pics/09-cvosn-sharedvpc.jpg)
