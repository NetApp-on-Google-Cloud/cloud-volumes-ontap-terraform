...
Cloud Volumes ONTAP High Availability with multiple Persistent Disks using Shared VPC, Tiering, custom firewall rules and Cloud Backup

## Diagram

![account-id1](./../pics/20-cvoha-sharedvpc.jpg)
