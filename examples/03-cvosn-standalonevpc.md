...
Cloud Volumes ONTAP Single Node with a single Persistent Disk using Standalone VPC, Tiering and custom firewall rules

## Diagram

![account-id1](./../pics/03-cvosn-standalonevpc.jpg)
